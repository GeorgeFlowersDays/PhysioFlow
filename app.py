...
# ==========================================
# BIBLIOTECA CLÍNICA Y TERAPÉUTICA (MÓDULO AUXILIAR)
# ==========================================
    ...
    if categoria == "Columna Lumbar & Pelvis":
        ...
        with col1:
            with st.container(border=True):
                ...
                st.markdown("* **Posición:** Paciente sentado al borde camilla, manos atrás, flexión dorsal.\n* **Ejecución:** Extensión de rodilla pasiva.\n* **Positivo:** Reproducción de sintomatología radicular.")
        with col2:
            with st.container(border=True):
                st.markdown("### 🔍 Test de Lasègue (SLR)")
                st.caption("**Región:** Columna Lumbar (Radicular)")
                st.markdown("* **Posición:** Paciente en decúbito supino.\n* **Ejecución:** Elevación pasiva de pierna recta.\n* **Positivo:** Dolor irradiado entre 30° y 70°.")

    elif categoria == "Columna Cervical & ATM":
        with st.container(border=True):
            st.markdown("### 🔍 Test de Spurling")
            st.caption("**Región:** Cervical")
            st.markdown("* **Posición:** Sentado con cabeza inclinada y rotada.\n* **Ejecución:** Carga axial descendente.\n* **Positivo:** Irradiación al brazo ipsilateral.")

    elif categoria == "Extremidad Inferior":
        with st.container(border=True):
            st.markdown("### 🔍 Test de Thomas")
            st.caption("**Región:** Cadera / Flexores")
            st.markdown("* **Posición:** Decúbito supino, rodillas al pecho.\n* **Ejecución:** Descender pierna fuera de camilla.\n* **Positivo:** Elevación del muslo (acortamiento de psoas).")

    elif categoria == "Extremidad Superior":
        with st.container(border=True):
            st.markdown("### 🔍 Test de Neer")
            st.caption("**Región:** Hombro / Subacromial")
            st.markdown("* **Posición:** Sentado o de pie, estabilizando escápula.\n* **Ejecución:** Elevación pasiva en rotación interna.\n* **Positivo:** Dolor anterolateral entre 90° y 130°.")
# ==========================================
